...
import { Loader2, KeyRound, ArrowLeft, AlertTriangle, CheckCircle, LogIn } from 'lucide-react'; // Added LogIn import
...
export default function UpdatePasswordPage() {
  ...
  // Supabase handles session recovery from URL hash on page load
  // if there's a recovery token. We don't need to parse it manually.
  // However, we can check if there was an error in the redirect.
  useEffect(() => {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (error) {
      ...
      // Optionally redirect to login after a delay or provide a button
